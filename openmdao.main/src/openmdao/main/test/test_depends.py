...
class DependsTestCase2(unittest.TestCase):
    ...
    def test_connected_vars(self):
        self.assertEqual(self.top._depgraph.list_outputs('c1'), [])
        self.assertEqual(self.top._depgraph.list_outputs('c2'), [])
        self.top.connect('c1.c', 'c2.a')
        self.assertEqual(self.top._depgraph.list_outputs('c1'), ['c1.c'])
        self.assertEqual(self.top._depgraph.list_inputs('c2'), ['c2.a'])
        self.top.connect('c1.d', 'c2.b')
        self.assertEqual(set(self.top._depgraph.list_outputs('c1')), set(['c1.c', 'c1.d']))
        self.assertEqual(set(self.top._depgraph.list_inputs('c2')), set(['c2.a', 'c2.b']))
